...
CFLAGS           += /nologo /MT /W3 /DBUILD_ARB /DBUILD_NV30GL /DBUILD_DX9 /DWIN32 /DWINDOWS /EHsc /Zm500 /I C:/DX90SDK/INCLUDE
...
LDFLAGS           += /nologo /map /fixed:no /INCREMENTAL:NO /libpath:C:\\DX90SDK\\LIB
