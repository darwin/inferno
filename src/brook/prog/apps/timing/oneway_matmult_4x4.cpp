...
void __oneway_matmult_4x4_cpu_inner (const __cpustruct_matrix4 &a,
...
void  __oneway_matmult_4x4_cpu (const std::vector<void *>&args,
  ...
  unsigned int i=0; 
  while (i<mapextent) {
    __oneway_matmult_4x4_cpu_inner (
      *(arg0 + iter0),
      *(arg1 + iter1),
      *arg2);
    i++;
...
void  oneway_matmult_4x4 (::brook::stream a,
  ...
  static const void *__oneway_matmult_4x4_fp[] = {
     ...
     "cpu", (void *) __oneway_matmult_4x4_cpu,
     NULL, NULL };
  static __BRTKernel k(__oneway_matmult_4x4_fp);
...
void __oneway_matmult_4x4_pretransposed_cpu_inner (const __cpustruct_matrix4 &a,
                                                    const __cpustruct_matrix4 &b,
                                                    __cpustruct_matrix4 &result){
...
void  __oneway_matmult_4x4_pretransposed_cpu (const std::vector<void *>&args,
                                              const std::vector<const unsigned int *>&extents,
                                              const std::vector<unsigned int>&dims,
                                              unsigned int mapbegin, 
                                              unsigned int mapextent) {
  ...
  unsigned int i=0; 
  while (i<mapextent) {
    __oneway_matmult_4x4_pretransposed_cpu_inner (
      *(arg0 + iter0),
      *(arg1 + iter1),
      *arg2);
    i++;
...
void  oneway_matmult_4x4_pretransposed (::brook::stream a,
  ...
  static const void *__oneway_matmult_4x4_pretransposed_fp[] = {
     ...
     "cpu", (void *) __oneway_matmult_4x4_pretransposed_cpu,
     NULL, NULL };
  static __BRTKernel k(__oneway_matmult_4x4_pretransposed_fp);
